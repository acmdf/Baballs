...
public:
    ...
    struct Model3D {
        ...
        Model3D() : overlayHandle(vr::k_ulOverlayHandleInvalid), 
                   textureId(0), framebuffer(0), depthBuffer(0),
                   vertexBuffer(0), indexBuffer(0), normalBuffer(0), uvBuffer(0),
                   indexCount(0), position({0,0,0}), rotation({0,0,0}), scale({1,1,1}),
